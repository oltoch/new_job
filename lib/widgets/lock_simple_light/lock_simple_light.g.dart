...
class LockSimpleLight extends StatefulWidget {
  ...
  @override
  _LockSimpleLight createState() => _LockSimpleLight();
}

class _LockSimpleLight extends State<LockSimpleLight> {
  _LockSimpleLight();
        ...
        child: Stack(children: [
          Positioned(
            ...
            child: Stack(children: [
              ...
              Positioned(
                left: widget.constraints.maxWidth * 0.359,
                width: widget.constraints.maxWidth * 0.281,
                top: widget.constraints.maxHeight * 0.063,
                height: widget.constraints.maxHeight * 0.281,
                child: SvgPicture.asset(
                  'assets/images/vector.svg',
                  package: 'tolulope',
                  width: widget.constraints.maxWidth * 0.281,
